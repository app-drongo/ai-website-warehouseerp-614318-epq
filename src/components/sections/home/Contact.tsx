...
const DEFAULT_CONTACT = {
  ...
  formDescription:
    "Tell us about your warehouse needs and we'll get back to you within 24 hours with a customized solution.",
  ...
  supportNote: '24/7 support available for all Enterprise customers',
  nameLabel: 'Full Name *',
  ...
  currentErpPlaceholder: 'Select your current system',
  messageLabel: 'Tell us about your warehouse needs *',
  messagePlaceholder:
    "Describe your current warehouse challenges, number of locations, inventory volume, and what you're looking to improve...",
} as const;
...
export default function Contact(props: ContactProps) {
  ...
  const erpOptions = [
    { value: '', label: 'Select your current system' },
    { value: 'SAP', label: 'SAP' },
