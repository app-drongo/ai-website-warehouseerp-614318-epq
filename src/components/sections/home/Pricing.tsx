...
const DEFAULT_PRICING = {
  ...
  bottomDescription:
    "We offer tailored ERP solutions for enterprises with specific warehouse management requirements. Let's discuss how WarehousePro can optimize your operations.",
